...
let numero_treinta = 30
let string_treinta = '30'

// Comparaciones
if (numero_uno == string_uno) {
    console.log('Las variables tienen el mismo valor pero no el mismo tipo');
} else {
    console.log('Las variables no tienen el mismo valor')
};

console.log('El valor de la variable numero_uno es: ' + numero_uno.valueOf() + ', pero el tipo es: ' + typeof(numero_uno));
console.log('El valor de la variable string_uno es: ' + string_uno.valueOf() + ', pero el tipo es: ' + typeof(string_uno));


if (numero_diez == string_diez) {
    console.log('Las variables tienen el mismo valor pero no el mismo tipo');
} else {
    console.log('Las variables no tienen el mismo valor')
};
